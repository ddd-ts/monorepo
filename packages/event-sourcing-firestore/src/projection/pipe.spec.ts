...
//       execute(input: this["_of"][], context: this["needs"]): Promise<any> {
//         throw new Error("Method not implemented.");
//       }
//     }
...
// const SimpleHandler = Subtrait([{} as ReturnType<typeof Handler>], (base) => {
//   abstract class Parallel extends base {
//     declare needs: {};
//     declare exposes: {};

//     abstract handle<R>(
//       input: this["_of"],
//       context: this["exposes"],
//     ): Promise<R>;

//     async execute(input: this["_of"][], context: this["needs"]) {
...
// const BatchingHandler = Subtrait([{} as ReturnType<typeof Handler>], (base) => {
//   abstract class Batching extends base {
//     declare needs: {};
//     declare exposes: {};
...
//   @Listen(Withdrawn, {
//     batch: true,
//     shard: (event) => event.payload.accountId,
//     locks: (event) => ({}),
//     checkpointing: "transactional",
//     retry: 3,
//     timeout: 1000,
//   })
//   onWithdrawn() {}
